...
class adaptador_video_tarea(
    var context: Context,
    var listaRecurso: ArrayList<RecursosTarea>
): RecyclerView.Adapter<adaptador_video_tarea.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       val recurso = listaRecurso[position]
        holder.video.setVideoURI(Uri.parse(recurso.uri))
