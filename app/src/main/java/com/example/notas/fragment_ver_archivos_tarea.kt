 ...
 */
class fragment_ver_archivos_tarea : Fragment() {
    ...
    private fun initialize(root: View,id: Int){
        ...
        val lista: ArrayList<RecursosTarea>? = context?.let {
            daoRecursosTarea(it).getAllByFileType(id)
        }
        if(lista != null){
            val adapter = context?.let {
                adaptador_archivos_tarea(it,lista)
            }
